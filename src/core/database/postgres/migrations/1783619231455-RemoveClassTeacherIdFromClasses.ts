...
export class RemoveClassTeacherIdFromClasses1783619231455 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "e_schooling"."teacher_section_assignments" ADD CONSTRAINT "FK_ddd2f99a03a6ec49066f91bc31b" FOREIGN KEY ("teacher_id") REFERENCES "e_schooling"."school_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "e_schooling"."teacher_section_assignments" DROP CONSTRAINT "FK_ddd2f99a03a6ec49066f91bc31b"`);
