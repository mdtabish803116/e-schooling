...
export class State {
  ...
  @Index({ unique: true })
  @Column({ name: 'name', type: 'varchar', nullable: false, comment: 'State or Union Territory name' })
  name: string;

  @Index({ unique: true })
  @Column({ name: 'code', type: 'varchar', nullable: false, comment: 'ISO or standardized short code e.g. MH, UP, KA' })
  code: string;
