...
export class ModuleMaster {
  ...
  @Column({ name: 'show_in_sidebar', type: 'boolean', default: true, comment: 'Visibility toggle for sidebar' })
  showInSidebar: boolean;

  @Column({ name: 'is_menu_group', type: 'boolean', default: false, comment: 'True if this is just a folder/label' })
  isMenuGroup: boolean;

  @Column({ name: 'is_visible', type: 'boolean', default: true, comment: 'Dynamic visibility toggle' })
  isVisible: boolean;
