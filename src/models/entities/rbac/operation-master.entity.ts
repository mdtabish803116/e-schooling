...
export class OperationMaster {
  ...
  @Column({ name: 'name', type: 'varchar', nullable: false, comment: 'Display operation name e.g. View, Create, Approve' })
  name: string;

  @Index({ unique: true })
  @Column({ name: 'code', type: 'varchar', nullable: false, comment: 'Action shortcode e.g. VIEW, CREATE, UPDATE, DELETE' })
  code: string;
