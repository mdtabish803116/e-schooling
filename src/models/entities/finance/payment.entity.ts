...
export class Payment {
  ...
  @Column({ name: 'transaction_id', type: 'varchar', nullable: true, comment: 'Transaction ID' })
  transactionId: string;

  @Column({ name: 'payment_gateway', type: 'varchar', nullable: true, comment: 'razorpay | stripe | cashfree' })
  paymentGateway: PaymentGatewayEnum;

  @Column({ name: 'gateway_payment_id', type: 'varchar', nullable: true, comment: 'Gateway Payment ID' })
  gatewayPaymentId: string;

  @Column({ name: 'amount', type: 'decimal', nullable: true, comment: 'Payment amount' })
  amount: number;
  ...
  @Column({ name: 'invoice_url', type: 'varchar', nullable: true, comment: 'Invoice PDF URL' })
  invoiceUrl: string;
