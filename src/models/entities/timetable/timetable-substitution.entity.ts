...
export class TimetableSubstitution {
  ...
  @Index()
  @Column({ name: 'slot_id', type: 'bigint', nullable: false, comment: 'Reference to TimetableSlot' })
  slotId: string;

  @Index()
  @Column({ name: 'original_teacher_id', type: 'bigint', nullable: false, comment: 'Original assigned teacher' })
  originalTeacherId: string;

  @Index()
  @Column({ name: 'substitute_teacher_id', type: 'bigint', nullable: false, comment: 'Substitute assigned teacher' })
  substituteTeacherId: string;

  @Column({ name: 'date', type: 'date', nullable: false, comment: 'Date of substitution' })
  date: string;

  @Index()
  @Column({ name: 'period_id', type: 'bigint', nullable: true, comment: 'Reference to Period' })
  periodId: string;
