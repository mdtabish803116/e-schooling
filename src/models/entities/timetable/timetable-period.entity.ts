...
export class TimetablePeriod {
  ...
  @Column({ name: 'name', type: 'varchar', nullable: false, comment: 'Period name (e.g. Period 1)' })
  name: string;

  @Column({ name: 'start_time', type: 'varchar', nullable: false, comment: 'Start time (e.g. 08:30 AM)' })
  startTime: string;

  @Column({ name: 'end_time', type: 'varchar', nullable: false, comment: 'End time (e.g. 09:20 AM)' })
  endTime: string;

  @Column({ name: 'type', type: 'varchar', nullable: false, default: PeriodTypeEnum.TEACHING, comment: 'Type (Teaching, Break, Assembly)' })
  type: PeriodTypeEnum;

  @Column({ name: 'display_order', type: 'integer', nullable: false, default: 1, comment: 'Sorting display order' })
  displayOrder: number;
