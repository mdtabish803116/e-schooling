...
export class Student {
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'Unique student identification code used for login',
  })
  studentCode: string;
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'Primary phone number (legacy field)',
  })
  phone: string;
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'Mobile / WhatsApp number',
  })
  mobile: string;
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'Generic parent name (legacy)',
  })
  parentName: string;
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'Generic parent phone (legacy)',
  })
  parentPhone: string;
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: "Father's Aadhaar number",
  })
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: "Mother's Aadhaar number",
  })
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: "Guardian's relationship to student",
  })
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: "Guardian's mobile number",
  })
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'Relation of emergency contact to student',
  })
  ...
  @Column({
    ...
    type: 'text',
    nullable: true,
    comment: 'Known medical conditions',
  })
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'Physical/learning disability if any',
  })
  disability: string;
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'Family doctor contact number',
  })
  doctorPhone: string;
  ...
  @Column({
    ...
    type: 'jsonb',
    nullable: true,
    comment: 'Previous school details as JSON',
  })
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'URL of the student profile picture',
  })
  ...
  @Column({
    ...
    nullable: true,
    default: '[]',
    comment: 'Uploaded student verification documents',
  })
  documents: any;
  ...
  @Column({
    ...
    type: 'bigint',
    nullable: true,
    comment: 'Reference to custom local Place/Village cluster',
  })
  placeId: string;
