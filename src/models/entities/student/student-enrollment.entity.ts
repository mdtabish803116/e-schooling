...
export class StudentEnrollment {
  ...
  @Column({
    ...
    nullable: true,
    comment:
      'admission | promotion | demotion | transfer | repeat | special_promotion',
  })
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'active | promoted | demoted | transferred | completed | dropped',
  })
  ...
  @Column({
    ...
    type: 'boolean',
    default: false,
    comment: "Whether this is the student's current active enrollment",
  })
  isCurrent: boolean;
  ...
  @Column({
    ...
    type: 'date',
    nullable: true,
    comment: 'Enrollment end date (set when student is promoted/transferred)',
  })
  endDate: string;
