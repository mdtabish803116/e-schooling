...
export class PlatformFeature {
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: false,
    comment: 'Display name e.g. WhatsApp Integration',
  })
  name: string;
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: false,
    comment: 'Unique identification code',
  })
  code: string;
  ...
  @Column({
    ...
    type: 'text',
    nullable: true,
    comment: 'Capability documentation',
  })
  description?: string;
  ...
  @Column({
    ...
    nullable: false,
    default: false,
    comment: 'True if metered consumption applies',
  })
  isMetered: boolean;
  ...
  @Column({
    ...
    type: 'varchar',
    nullable: true,
    comment: 'Default limit/quota value for this feature or booster',
  })
  defaultLimit?: string;
  ...
  @Column({
    ...
    nullable: false,
    default: true,
    comment: 'Global availability toggle',
  })
  isActive: boolean;
