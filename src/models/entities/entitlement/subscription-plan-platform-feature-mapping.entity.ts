...
@Entity({
  name: 'subscription_plan_platform_feature_mappings',
  schema: 'e_schooling',
})
export class SubscriptionPlanPlatformFeatureMapping {
  ...
  @Column({
    ...
    nullable: false,
    default: true,
    comment: 'Baseline feature enabled state',
  })
  isEnabled: boolean;
  ...
  @Column({
    ...
    type: 'bigint',
    nullable: true,
    comment: 'Default quota limit. Null means unlimited',
  })
  ...
  @Column({
    ...
    type: 'jsonb',
    nullable: true,
    comment: 'Extensible plan configuration details',
  })
