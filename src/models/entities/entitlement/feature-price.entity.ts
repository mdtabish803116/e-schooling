...
export class FeaturePrice {
  ...
  @Column({ name: 'billing_cycle', type: 'varchar', nullable: false, comment: 'monthly | yearly | per_unit' })
  billingCycle: string; // Using string to allow 'per_unit' or BillingCycleEnum

  @Column({ name: 'price', type: 'decimal', precision: 10, scale: 2, nullable: false, comment: 'Price for the specific cycle' })
  price: number;
