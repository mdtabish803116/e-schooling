...
export class AuthController {
  ...
  @ApiResponse({ 
    ...
    schema: {
      example: {
        token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...',
        user: { id: '5', name: 'Rahul Teacher', username: 'teacher_rahul', roles: ['teacher'] }
      }
    }
  })
  @Post('user/login')
  ...
  @ApiResponse({ 
    ...
    schema: {
      example: {
        token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...',
        student: { id: '10', studentCode: 'SCH-BLUE-2024-001', firstName: 'Amit', lastName: 'Kumar', roles: ['student'] }
      }
    }
  })
  @Post('student/login')
  ...
  @ApiResponse({ 
    ...
    schema: {
      example: {
        token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...',
        user: { id: '1', name: 'Super Admin', email: 'admin@eschool.com', roles: ['super_admin'] }
      }
    }
  })
  @Post('platform/login')
