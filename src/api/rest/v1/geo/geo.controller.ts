...
export class GeoController {
  ...
  @ApiOperation({
    summary: 'Fetch all active globally available States/Provinces',
  })
  @Get('states')
  async getStates() {
  ...
  @ApiOperation({
    summary:
      'Fetch all active regional Districts belonging to a target State context',
  })
  ...
  @ApiOperation({
    summary:
      'List all custom tenant branch locations, villages, and cluster parameters',
  })
  @ApiQuery({
    name: 'districtId',
    required: false,
    description: 'Filter by specific parent District ID',
  })
  ...
  @ApiOperation({
    summary:
      'Create customized villages, local blocks, or city centers exclusively bound to the target branch record',
  })
