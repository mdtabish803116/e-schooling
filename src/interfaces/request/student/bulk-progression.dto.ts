...
export class BulkProgressionDto {
  @ApiProperty({ example: ['1', '2'], description: 'IDs of the students to progress' })
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiProperty({ example: 'Passed final exams - bulk promotion', description: 'Remarks', required: false })
  @IsString()
  @IsOptional()
  remarks?: string;
}
